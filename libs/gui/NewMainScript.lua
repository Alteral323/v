...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/Alteral323/v/main/libs/gui/assetsversion.dat",
		Method = "GET"
	})
...
if not betterisfile("vape-v4/assetsversion.dat") then
	writefile("vape-v4/assetsversion.dat", "1")
end
...
if not betterisfile("vape-v4/language.dat") then
	writefile("vape-v4/language.dat", "en-us")
end
local assetver = checkassetversion()
if assetver and assetver > readfile("vape-v4/assetsversion.dat") then
	if shared.VapeDeveloper == nil then
		if isfolder("vape-v4/assets") then
			if delfolder then
				delfolder("vape-v4/assets")
			end
		end
		writefile("vape-v4/assetsversion.dat", assetver)
	end
end
if isfolder("vape-v4/assets") == false then
	makefolder("vape-v4/assets")
end
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/Alteral323/v/main/libs/gui/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
local Combat = GuiLibrary.CreateWindow({
	["Name"] = "Combat", 
	["Icon"] = "vape-v4/assets/CombatIcon.png", 
	["IconSize"] = 15
})
local Blatant = GuiLibrary.CreateWindow({
	["Name"] = "Blatant", 
	["Icon"] = "vape-v4/assets/BlatantIcon.png", 
	["IconSize"] = 16
})
local Render = GuiLibrary.CreateWindow({
	["Name"] = "Render", 
	["Icon"] = "vape-v4/assets/RenderIcon.png", 
	["IconSize"] = 17
})
local Utility = GuiLibrary.CreateWindow({
	["Name"] = "Utility", 
	["Icon"] = "vape-v4/assets/UtilityIcon.png", 
	["IconSize"] = 17
})
local World = GuiLibrary.CreateWindow({
	["Name"] = "World", 
	["Icon"] = "vape-v4/assets/WorldIcon.png", 
	["IconSize"] = 16
})
local Friends = GuiLibrary.CreateWindow2({
	["Name"] = "Friends", 
	["Icon"] = "vape-v4/assets/FriendsIcon.png", 
	["IconSize"] = 17
})
local Profiles = GuiLibrary.CreateWindow2({
	["Name"] = "Profiles", 
	["Icon"] = "vape-v4/assets/ProfilesIcon.png", 
	["IconSize"] = 19
})
GUI.CreateDivider()
GUI.CreateButton({
...
OnlineProfilesButtonImage.Image = getcustomassetfunc("vape-v4/assets/OnlineProfilesButton.png")
...
OnlineProfilesExitButton.Image = getcustomassetfunc("vape-v4/assets/ExitIcon1.png")
...
OnlineProfilesFrameShadow.Image = getcustomassetfunc("vape-v4/assets/WindowBlur.png")
...
OnlineProfilesFrameIcon.Image = getcustomassetfunc("vape-v4/assets/ProfilesIcon.png")
...
GUI.CreateDivider()
---GUI.CreateCustomButton("Favorites", "vape-v4/assets/FavoritesListIcon.png", UDim2.new(0, 17, 0, 14), function() end, function() end)
--GUI.CreateCustomButton("Text GUIVertical", "vape-v4/assets/TextGUIIcon3.png", UDim2.new(1, -56, 0, 15), function() end, function() end)
local TextGui = GuiLibrary.CreateCustomWindow({
	["Name"] = "Text GUI", 
	["Icon"] = "vape-v4/assets/TextGUIIcon1.png", 
	["IconSize"] = 21
})
local TextGuiCircleObject = {["CircleList"] = {}}
--GUI.CreateCustomButton("Text GUI", "vape-v4/assets/TextGUIIcon2.png", UDim2.new(1, -23, 0, 15), function() TextGui.SetVisible(true) end, function() TextGui.SetVisible(false) end, "OptionsButton")
GUI.CreateCustomToggle({
	["Name"] = "Text GUI", 
	["Icon"] = "vape-v4/assets/TextGUIIcon3.png",
...
onething.Image = getcustomassetfunc(translatedlogo and "vape-v4/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "vape-v4/assets/VapeLogo3.png")
...
onething2.Image = getcustomassetfunc("vape-v4/assets/VapeLogo4.png")
...
textguimode = TextGui.CreateDropdown({
	...
	["Function"] = function(val)
		...
		if val == "Drawing" then
			...
			onethingdrawing.Data = readfile(translatedlogo and "vape-v4/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "vape-v4/assets/VapeLogo3.png")
			...
			onething2drawing.Data = readfile("vape-v4/assets/VapeLogo4.png")
			...
			onething3drawing.Data = readfile(translatedlogo and "vape-v4/translations/"..GuiLibrary["Language"].."/VapeLogo3.png" or "vape-v4/assets/VapeLogo3.png")
			...
			onething4drawing.Data = readfile("vape-v4/assets/VapeLogo4.png")
...
local TargetInfo = GuiLibrary.CreateCustomWindow({
	["Name"] = "Target Info",
	["Icon"] = "vape-v4/assets/TargetInfoIcon1.png",
	["IconSize"] = 16
})
...
healthbarbkgshadow.Image = getcustomassetfunc("vape-v4/assets/WindowBlur.png")
...
GUI.CreateCustomToggle({
	["Name"] = "Target Info", 
	["Icon"] = "vape-v4/assets/TargetInfoIcon2.png", 
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if (not teleported) and (not shared.VapeIndependent) then
		teleported = true
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape-v4/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/Alteral323/v/main/libs/gui/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
...
if shared.VapeIndependent then
	...
	if betterisfile("vape-v4/CustomModules/"..game.PlaceId..".lua") then
		loadstring(readfile("vape-v4/CustomModules/"..game.PlaceId..".lua"))()
	else
	...
	if shared.VapePrivate then
		if pcall(function() readfile("vape-v4-private/CustomModules/"..game.PlaceId..".lua") end) then
			loadstring(readfile("vape-v4-private/CustomModules/"..game.PlaceId..".lua"))()
		end	
	end
	GuiLibrary["LoadSettings"](shared.VapeCustomProfile)
	local profiles = {}
