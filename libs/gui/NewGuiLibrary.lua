if shared.VapeExecuted then
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("vape-v4/language.dat") and readfile("vape-v4/language.dat") or "en-us",
	...
	local function GetURL(scripturl)
		if shared.VapeDeveloper then
			if not betterisfile("vape-v4/"..scripturl) then
				error("File not found : vape-v4/"..scripturl)
			end
	...
	local translations = shared.VapeTranslation or {}--loadstring(GetURL("translations/"..api["Language"]..".vapetranslation") or GetURL("translations/en-us.vapetranslation"))()
	...
	searchbaricon.Image = getcustomassetfunc("vape-v4/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("vape-v4/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("vape-v4/assets/WindowBlur.png")
	...
	api["LoadSettings"] = function(customprofile)
		...
		if betterisfile("vape-v4/Profiles/GUIPositions.vapeprofile.txt") and game.GameId == 2619619496 then
			writefile("vape-v4/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("vape-v4/Profiles/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("vape-v4/Profiles/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if betterisfile("vape-v4-private/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and betterisfile("vape-v4/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
				writefile("vape-v4-private/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("vape-v4/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
			end
			if betterisfile("vape-v4-private/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and betterisfile("vape-v4/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("vape-v4-private/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("vape-v4/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
			if betterisfile("vape-v4-private/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and betterisfile("vape-v4/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("vape-v4-private/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("vape-v4/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("vape-v4/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "vape-v4/translations/"..api["Language"].."/VapeLogo1.png" or "vape-v4/assets/VapeLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("vape-v4/assets/VapeLogo2.png")
		...
		settingswheel.Image = getcustomassetfunc("vape-v4/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("vape-v4/assets/DiscordIcon.png")
		...
		settingsexit.Image = getcustomassetfunc("vape-v4/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("vape-v4/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("vape-v4/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("vape-v4/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("vape-v4/assets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("vape-v4/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("vape-v4/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("vape-v4/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("vape-v4/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc("vape-v4/assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc("vape-v4/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function() 
				bindimg.Image = getcustomassetfunc("vape-v4/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("vape-v4/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("vape-v4/assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.7
				val = val or 0.9
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("vape-v4/assets/ColorSlider2.png") or getcustomassetfunc("vape-v4/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("vape-v4/assets/RainbowIcon2.png") or getcustomassetfunc("vape-v4/assets/RainbowIcon1.png"))
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("vape-v4/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("vape-v4/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("vape-v4/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("vape-v4/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "vape-v4/assets/TextBoxBKG2.png" or "vape-v4/assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc("vape-v4/assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("vape-v4/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("vape-v4/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("vape-v4/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("vape-v4/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("vape-v4/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("vape-v4/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("vape-v4/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("vape-v4/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vape-v4/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vape-v4/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vape-v4/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "vape-v4/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("vape-v4/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:Connect(function()
					sliderexpand.Image = getcustomassetfunc("vape-v4/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("vape-v4/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("vape-v4/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("vape-v4/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("vape-v4/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = getcustomassetfunc("vape-v4/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = getcustomassetfunc("vape-v4/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("vape-v4/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("vape-v4/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "vape-v4/"..customicon or "vape-v4/assets/InfoNotification.png")
